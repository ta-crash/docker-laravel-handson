                        ...
                        <td>
                            <span id="blood_types">
                                @foreach ($configs['bloodTypes'] as $bloodType => $description)
                                    <input type="checkbox" name="blood_types[]" value="{{ $bloodType }}" id="{{ 'bloodType' . $bloodType }}" {{ in_array($bloodType, old('blood_types', $conditions['blood_types'] ?? [])) ? 'checked' : '' }}>
                                    <label for="{{ 'bloodType' . $bloodType }}">{{ $description }}</label>
                                @endforeach
                            </span>
                            @error('prefectures')
                                <span>{{ $message }}</span>
