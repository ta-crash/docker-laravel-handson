            ...
            <div id="personal_information">
                ...
                <div>
                    ...
                    @foreach ($configs['genders'] as $gender => $description)
                        <input type="radio" name="gender" id="{{ $gender }}" value="{{ $gender }}" {{ old('gender', $user->gender->value) === $gender ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <span id="birthday">
                        <input type="text" name="birth_year" value="{{ $user->birth_year }}">年
                        <input type="text" name="birth_month" value="{{ $user->birth_month }}">月
                        <input type="text" name="birth_date" value="{{ $user->birth_date }}">日
                    </span>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="address_building" value="{{ $user->address_building }}">
                </div>
            </div>
